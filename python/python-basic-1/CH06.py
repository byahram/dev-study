...
# 리스트와 튜플로 변환하여 세트 요소에 접근하기 예제 1
print(">> 리스트와 튜플로 변환하여 세트 요소에 접근하기 예제 1")
str_banana = "banana"
set_banana = set(str_banana)
print(set_banana)
...
# 리스트와 튜플로 변환하여 세트 요소에 접근하기 예제 2
print(">> 리스트와 튜플로 변환하여 세트 요소에 접근하기 예제 2")
str_apple = "apple"
